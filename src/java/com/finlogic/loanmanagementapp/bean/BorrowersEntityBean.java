 ...
 * @author Shivangi
 */
public class BorrowersEntityBean {
    ...
    public BorrowersEntityBean(){}

    public BorrowersEntityBean(int id, String firstName, String lastName, String dateOfBirth, String gender, String panNumber, String country, String state, String city, String pincode, String address, String mobile, String email, String workingStatus, String photo) {
        this.id = id;
